...
<div class="container mx-auto p-6">
    <div class="relative overflow-x-auto">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('manage-mahasiswa.create') }}" class="bg-green-500 text-white px-4 py-2 rounded mb-4 inline-block">Tambah Mahasiswa</a>
        </div>
    </div>
        ...
        <table class="min-w-full bg-white text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $mhs->tempat_lahir }}</td>
                    <td class="border px-4 py-2">{{ $mhs->tanggal_lahir->format('d/m/Y') }}</td>
                    ...
                    <td class="border px-4 py-2">
                        <a href="{{ route('manage-mahasiswa.edit', $mhs->id) }}">
                    ...
                    <td class="border px-4 py-2">
                        <form action="{{ route('manage-mahasiswa.destroy', $mhs->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
